    ...
    (function(ApplicationInsights) {
        ...
        var _InternalLogMessage = (function() {
            function _InternalLogMessage(msgId, msg, properties) {
                ...
                const diagnosticText = (msg ? ` message:${_InternalLogMessage.sanitizeDiagnosticText(msg)}` : "") +
        ...
        const _InternalLogging = (function() {
            ...
            _InternalLogging.clearInternalMessageLoggedTypes = function() {
                if (ApplicationInsights.Util.canUseSessionStorage()) {
                    const sessionStorageKeys = ApplicationInsights.Util.getSessionStorageKeys();
            ...
            _InternalLogging.logInternalMessage = function(severity, message) {
                ...
                var logMessage = true;
                if (ApplicationInsights.Util.canUseSessionStorage()) {
                    const storageMessageKey = _InternalLogging.AIInternalMessagePrefix +
                        _InternalMessageId[message.messageId];
                    const internalMessageTypeLogRecord = ApplicationInsights.Util.getSessionStorage(storageMessageKey);
        ...
        const Util = (function() {
            ...
            Util.getStorage = function(name) {
                ...
                if (storage !== null) {
                    try {
                        ...
                        const message = new ApplicationInsights
            ...
            Util.dump = function(object) {
                ...
                if (objectTypeDump === "[object Error]") {
                    propertyValueDump = `{ stack: '${object
                        .stack}', message: '${object.message}', name: '${object.name}'`;
                }
    ...
    (function(ApplicationInsights) {
        ...
        const AjaxMonitor = (function() {
            ...
            AjaxMonitor.prototype.openHandler = function(xhr, method, url, async) {
                const ajaxData = new ApplicationInsights.ajaxRecord(ApplicationInsights.Util.newId());
            ...
            AjaxMonitor.prototype.sendHandler = function(xhr, content) {
                ...
                (ApplicationInsights.UrlHelper.parseUrl(xhr.ajaxData
                        .getAbsoluteUrl())
                    .host ==
                    ...
                    .AttachEvent(xhr,
                        ...
                        function() {
                            try {
                                ...
                                const exceptionText = Microsoft.ApplicationInsights.Util.dump(e);
...
(function(Microsoft) {
    var ApplicationInsights;
    (function(ApplicationInsights) {
        const HashCodeScoreGenerator = (function() {
    ...
    (function(ApplicationInsights) {
        ...
        const Serializer = (function() {
            ...
            Serializer.serialize = function(input) {
                const output = Serializer._serializeObject(input, "root");
                ...
                if (!!sources) {
                    if (!ApplicationInsights.Util.isArray(sources)) {
                        ...
                        for (let i = 0; i < sources.length; i++) {
                            ...
                            const item = Serializer._serializeObject(source, name + "[" + i + "]");
                            output.push(item);
                        }
                    }
                }
...
(function(Microsoft) {
    ...
    (function(ApplicationInsights) {
        ...
        (function(Telemetry) {
            ...
            (function(Common) {
                "use strict";
                const Envelope = (function(_super) {
...
(function(Microsoft) {
    var ApplicationInsights;
    (function(ApplicationInsights) {
        const SamplingScoreGenerator = (function() {
            ...
            SamplingScoreGenerator.prototype.getSamplingScore = function(envelope) {
                const tagKeys = new AI.ContextTagKeys();
                var score = 0;
            ...
            const Sample = (function() {
                ...
                Sample.prototype.isSampledIn = function(envelope) {
                    if (this.sampleRate == 100)
                        return true;
                    const score = this.samplingScoreGenerator.getSamplingScore(envelope);
...
(function(AI) {
    ...
    const SessionState = AI.SessionState;
})(AI || (AI = {}));
var Microsoft;
(function(Microsoft) {
    var ApplicationInsights;
...
(function(Microsoft) {
    ...
    (function(ApplicationInsights) {
        ...
        (function(Context) {
            ...
            const _SessionManager = (function() {
                ...
                _SessionManager.prototype.update = function() {
                    ...
                    const now = +new Date;
                    const acquisitionExpired = now - this.automaticSession.acquisitionDate >
                ...
                _SessionManager.prototype.initializeAutomaticSession = function() {
                    const cookie = ApplicationInsights.Util.getCookie("ai_session");
                    if (cookie && typeof cookie.split === "function") {
                        this.initializeAutomaticSessionWithData(cookie);
                    } else {
                        const storage = ApplicationInsights.Util.getStorage("ai_session");
                        if (storage) {
                    ...
                    try {
                        ...
                        ApplicationInsights._InternalLogging
                            .throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL,
                                ...
                                ._InternalLogMessage(ApplicationInsights._InternalMessageId
                                    .NONUSRACT_ErrorParsingAISessionCookie,
                                    `Error parsing ai_session cookie, session will be reset: ${ApplicationInsights.Util
                                    .getExceptionName(e)}`,
        ...
        (function(Context) {
            ...
            const User = (function() {
                function User(config) {
                    const cookie = ApplicationInsights.Util.getCookie(User.userCookieName);
                    if (cookie) {
                    ...
                    if (!this.id) {
                        this.id = ApplicationInsights.Util.newId();
                        const date = new Date();
                        const acqStr = ApplicationInsights.Util.toISOStringForIE8(date);
                ...
                User.prototype.setAuthenticatedUserContext = function(authenticatedUserId, accountId) {
                    const isInvalidInput = !this.validateUserInput(authenticatedUserId) ||
...
(function(Microsoft) {
    ...
    (function(ApplicationInsights) {
        "use strict";
        const DataLossAnalyzer = (function() {
            ...
            DataLossAnalyzer.getIssuesReported = function() {
                const result = (!DataLossAnalyzer.isEnabled() ||
            ...
            DataLossAnalyzer.incrementItemsQueued = function() {
                try {
                    if (DataLossAnalyzer.isEnabled()) {
                        let itemsQueued = DataLossAnalyzer.getNumberOfLostItems();
                        ++itemsQueued;
            ...
            DataLossAnalyzer.reportLostItems = function() {
                try {
                    if (DataLossAnalyzer.isEnabled() &&
                        ...
                        const lostItems = DataLossAnalyzer.getNumberOfLostItems() -
                        ...
                        let issuesReported = DataLossAnalyzer.getIssuesReported();
                        ++issuesReported;
                        ApplicationInsights.Util
...
(function(Microsoft) {
    ...
    (function(ApplicationInsights) {
        "use strict";
        const ArraySendBuffer = (function() {
            ...
            ArraySendBuffer.prototype.batchPayloads = function(payload) {
                if (payload && payload.length > 0) {
                    const batch = this._config.emitLineDelimitedJson() ? payload.join("\n") : `[${payload.join(",")}]`;
                    return batch;
                }
                return null;
            };
        ...
        const SessionStorageSendBuffer = (function() {
            ...
            SessionStorageSendBuffer.prototype.getBuffer = function(key) {
                try {
                    const bufferJson = ApplicationInsights.Util.getSessionStorage(key);
                    if (bufferJson) {
        ...
        const Sender = (function() {
            ...
            Sender.prototype.send = function(envelope) {
                ...
                try {
                    ...
                    const payload = ApplicationInsights.Serializer.serialize(envelope);
                    ...
                    if (!ApplicationInsights.Util.getIEVersion() || ApplicationInsights.Util.getIEVersion() > 9) {
                        ApplicationInsights._InternalLogging
                            .throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL,
                                ...
                                ._InternalLogMessage(ApplicationInsights._InternalMessageId
                                    .NONUSRACT_TransmissionFailed,
                                    `Telemetry transmission failed, some telemetry will be lost: ${ApplicationInsights
...
(function(AI) {
    ...
    const SeverityLevel = AI.SeverityLevel;
})(AI || (AI = {}));
...
(function(AI) {
    "use strict";
    const MessageData = (function(_super) {
                                ...
                                ApplicationInsights._InternalLogging
                                    .throwInternalUserActionable(ApplicationInsights.LoggingSeverity.WARNING,
                                        ...
                                        ._InternalLogMessage(ApplicationInsights._InternalMessageId.USRACT_NameTooLong,
                                            `name is too long.  It has been truncated to ${DataSanitizer.MAX_NAME_LENGTH
                                            } characters.`,
                                            { name: name }));
                            }
                        }
                                ...
                                ApplicationInsights._InternalLogging
                                    .throwInternalUserActionable(ApplicationInsights.LoggingSeverity.WARNING,
                                        ...
                                        ._InternalLogMessage(ApplicationInsights._InternalMessageId
                                            ...
                                            DataSanitizer.MAX_STRING_LENGTH} characters.`,
                                            { value: value }));
                            }
                        }
                        return value;
                                ...
                                ApplicationInsights._InternalLogging
                                    .throwInternalUserActionable(ApplicationInsights.LoggingSeverity.WARNING,
                                        ...
                                        ._InternalLogMessage(ApplicationInsights._InternalMessageId.USRACT_UrlTooLong,
                                            `url is too long, it has been trucated to ${DataSanitizer.MAX_URL_LENGTH
                                            } characters.`,
                                            { url: url }));
                            }
                        }
                                ...
                                ApplicationInsights._InternalLogging
                                    .throwInternalUserActionable(ApplicationInsights.LoggingSeverity.WARNING,
                                        ...
                                        ._InternalLogMessage(ApplicationInsights._InternalMessageId
                                            ...
                                            DataSanitizer.MAX_MESSAGE_LENGTH} characters.`,
                                            { message: message }));
                            }
                        }
                        return message;
                                ...
                                ApplicationInsights._InternalLogging
                                    .throwInternalUserActionable(ApplicationInsights.LoggingSeverity.WARNING,
                                        ...
                                        ._InternalLogMessage(ApplicationInsights._InternalMessageId
                                            ...
                                            DataSanitizer.MAX_EXCEPTION_LENGTH} characters.`,
                                            { exception: exception }));
                            }
                        }
                        return exception;
                    ...
                    DataSanitizer.sanitizeProperties = function(properties) {
                        if (properties) {
                            ...
                            for (let prop in properties) {
                                const value = DataSanitizer.sanitizeString(properties[prop]);
...
(function(AI) {
    "use strict";
    const EventData = (function(_super) {
...
(function(AI) {
    "use strict";
    const ExceptionDetails = (function() {
...
(function(AI) {
    "use strict";
    const ExceptionData = (function(_super) {
...
(function(AI) {
    "use strict";
    const MetricData = (function(_super) {
...
(function(AI) {
    ...
    const DataPointType = AI.DataPointType;
})(AI || (AI = {}));
...
(function(Microsoft) {
    ...
    (function(ApplicationInsights) {
        ...
        (function(Telemetry) {
            ...
            (function(Common) {
                "use strict";
                const DataPoint = (function(_super) {
        ...
        (function(Telemetry) {
            ...
            const Metric = (function(_super) {
                ...
                function Metric(name, value, count, min, max, properties) {
                    ...
                    const dataPoint = new Microsoft.ApplicationInsights.Telemetry.Common.DataPoint();
...
(function(AI) {
    "use strict";
    const PageViewData = (function(_super) {
...
(function(Microsoft) {
    ...
    (function(ApplicationInsights) {
        ...
        (function(Telemetry) {
            "use strict";
            const PageView = (function(_super) {
...
(function(AI) {
    "use strict";
    const PageViewPerfData = (function(_super) {
...
(function(Microsoft) {
    ...
    (function(ApplicationInsights) {
        ...
        (function(Telemetry) {
            "use strict";
            const PageViewPerformance = (function(_super) {
...
(function(Microsoft) {
    ...
    (function(ApplicationInsights) {
        "use strict";
        const TelemetryContext = (function() {
            ...
            TelemetryContext.prototype._track = function(envelope) {
                ...
                try {
                    this.telemetryInitializers = this.telemetryInitializers || [];
                    const telemetryInitializersCount = this.telemetryInitializers.length;
                    for (let i = 0; i < telemetryInitializersCount; ++i) {
                        const telemetryInitializer = this.telemetryInitializers[i];
                ...
                if (!doNotSendItem) {
                    if (envelope.name === ApplicationInsights.Telemetry.Metric.envelopeType ||
                        ...
                        const iKeyNoDashes = this._config.instrumentationKey().replace(/-/g, "");
...
(function(Microsoft) {
    ...
    (function(ApplicationInsights) {
        ...
        (function(Telemetry) {
            "use strict";
            const PageViewManager = (function() {
                    ...
                    var handle = setInterval(function() {
                            try {
                                if (Telemetry.PageViewPerformance.isPerformanceTimingDataReady()) {
                                    ...
                                    const pageViewPerformance = new Telemetry
                                ...
                                ApplicationInsights._InternalLogging
                                    .throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL,
                                        ...
                                        ._InternalLogMessage(ApplicationInsights._InternalMessageId
                                            ...
                                            `trackPageView failed on page load calculation: ${ApplicationInsights.Util
                                            .getExceptionName(e)}`,
                                            { exception: ApplicationInsights.Util.dump(e) }));
                            }
                        },
...
(function(Microsoft) {
    ...
    (function(ApplicationInsights) {
        ...
        (function(Telemetry) {
            "use strict";
            const PageVisitTimeManager = (function() {
                ...
                PageVisitTimeManager.prototype.stopPageVisitTimer = function() {
                    try {
                        if (ApplicationInsights.Util.canUseSessionStorage()) {
                            ...
                            const pageVisitDataJsonStr = ApplicationInsights.Util
                                .getSessionStorage(this.prevPageVisitDataKeyName);
                            if (pageVisitDataJsonStr) {
                                const prevPageVisitData = JSON.parse(pageVisitDataJsonStr);
                                prevPageVisitData
...
(function(AI) {
    ...
    const DependencyKind = AI.DependencyKind;
})(AI || (AI = {}));
var AI;
(function(AI) {
    "use strict";
    ...
    const DependencySourceType = AI.DependencySourceType;
})(AI || (AI = {}));
/// <reference path="Domain.ts" />
/// <reference path="DataPointType.ts" />
...
(function(AI) {
    "use strict";
    const RemoteDependencyData = (function(_super) {
...
(function(Microsoft) {
    ...
    (function(ApplicationInsights) {
        ...
        const AppInsights = (function() {
            function AppInsights(config) {
                var _this = this;
                this._trackAjaxAttempts = 0;
                this.config = config || {};
                const defaults = AppInsights.defaultConfig;
                ...
                const enableExperiment = new ApplicationInsights.SplitTest()
                    .isEnabled(this.config.instrumentationKey, 5);
                ...
                this._eventTracking.action = function(name, url, duration, properties, measurements) {
                    ...
                    const event = new ApplicationInsights.Telemetry.Event(name, properties, measurements);
                    const data = new ApplicationInsights.Telemetry.Common
                        .Data(ApplicationInsights.Telemetry.Event.dataType, event);
                    const envelope = new ApplicationInsights.Telemetry.Common
            ...
            AppInsights.prototype.sendPageViewInternal = function(name, url, duration, properties, measurements) {
                const pageView = new ApplicationInsights.Telemetry
            ...
            AppInsights.prototype.sendPageViewPerformanceInternal = function(pageViewPerformance) {
                const pageViewPerformanceData = new ApplicationInsights.Telemetry.Common
                    .Data(ApplicationInsights.Telemetry.PageViewPerformance.dataType, pageViewPerformance);
                const pageViewPerformanceEnvelope = new ApplicationInsights.Telemetry.Common
                    ...
                    ApplicationInsights._InternalLogging
                        .throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL,
                            ...
                            ._InternalLogMessage(ApplicationInsights._InternalMessageId.NONUSRACT_StartTrackFailed,
                                `startTrackPage failed, page view may not be collected: ${ApplicationInsights.Util
                                .getExceptionName(e)}`,
                                { exception: ApplicationInsights.Util.dump(e) }));
                }
            };
                    ...
                    ApplicationInsights._InternalLogging
                        .throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL,
                            ...
                            ._InternalLogMessage(ApplicationInsights._InternalMessageId.NONUSRACT_StopTrackFailed,
                                `stopTrackPage failed, page view will not be collected: ${ApplicationInsights.Util
                                .getExceptionName(e)}`,
                                { exception: ApplicationInsights.Util.dump(e) }));
                }
            };
                    ...
                    ApplicationInsights._InternalLogging
                        .throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL,
                            ...
                            ._InternalLogMessage(ApplicationInsights._InternalMessageId.NONUSRACT_TrackPVFailed,
                                `trackPageView failed, page view will not be collected: ${ApplicationInsights.Util
                                .getExceptionName(e)}`,
                                { exception: ApplicationInsights.Util.dump(e) }));
                }
            };
                    ...
                    ApplicationInsights._InternalLogging
                        .throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL,
                            ...
                            ._InternalLogMessage(ApplicationInsights._InternalMessageId.NONUSRACT_StartTrackEventFailed,
                                `startTrackEvent failed, event will not be collected: ${ApplicationInsights.Util
                                .getExceptionName(e)}`,
                                { exception: ApplicationInsights.Util.dump(e) }));
                }
            };
                    ...
                    ApplicationInsights._InternalLogging
                        .throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL,
                            ...
                            ._InternalLogMessage(ApplicationInsights._InternalMessageId.NONUSRACT_StopTrackEventFailed,
                                `stopTrackEvent failed, event will not be collected: ${ApplicationInsights.Util
                                .getExceptionName(e)}`,
                                { exception: ApplicationInsights.Util.dump(e) }));
                }
            };
            AppInsights.prototype.trackEvent = function(name, properties, measurements) {
                try {
                    const eventTelemetry = new ApplicationInsights.Telemetry.Event(name, properties, measurements);
                    const data = new ApplicationInsights.Telemetry.Common
                    ...
                    ApplicationInsights._InternalLogging
                        .throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL,
                            ...
                            ._InternalLogMessage(ApplicationInsights._InternalMessageId.NONUSRACT_TrackEventFailed,
                                `trackEvent failed, event will not be collected: ${ApplicationInsights.Util
                                .getExceptionName(e)}`,
                                { exception: ApplicationInsights.Util.dump(e) }));
                }
            };
            AppInsights.prototype.trackAjax = function(id,
                ...
                if (this.config.maxAjaxCallsPerView === -1 ||
                    ...
                    const dependency = new ApplicationInsights.Telemetry
                        .RemoteDependencyData(id, absoluteUrl, pathName, totalTime, success, resultCode, method);
                    const dependencyData = new ApplicationInsights.Telemetry.Common
            ...
            AppInsights.prototype.trackException = function(exception,
                ...
                try {
                    ...
                    const exceptionTelemetry = new ApplicationInsights.Telemetry
                    ...
                    ApplicationInsights._InternalLogging
                        .throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL,
                            ...
                            ._InternalLogMessage(ApplicationInsights._InternalMessageId.NONUSRACT_TrackExceptionFailed,
                                `trackException failed, exception will not be collected: ${ApplicationInsights.Util
                                .getExceptionName(e)}`,
                                { exception: ApplicationInsights.Util.dump(e) }));
                }
            };
            AppInsights.prototype.trackMetric = function(name, average, sampleCount, min, max, properties) {
                try {
                    const telemetry = new ApplicationInsights.Telemetry
                    ...
                    ApplicationInsights._InternalLogging
                        .throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL,
                            ...
                            ._InternalLogMessage(ApplicationInsights._InternalMessageId.NONUSRACT_TrackMetricFailed,
                                `trackMetric failed, metric will not be collected: ${ApplicationInsights.Util
                                .getExceptionName(e)}`,
                                { exception: ApplicationInsights.Util.dump(e) }));
                }
            };
            AppInsights.prototype.trackTrace = function(message, properties) {
                try {
                    const telemetry = new ApplicationInsights.Telemetry.Trace(message, properties);
                    const data = new ApplicationInsights.Telemetry.Common
                    ...
                    ApplicationInsights._InternalLogging
                        .throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.WARNING,
                            ...
                            ._InternalLogMessage(ApplicationInsights._InternalMessageId.NONUSRACT_TrackTraceFailed,
                                `trackTrace failed, trace will not be collected: ${ApplicationInsights.Util
                                .getExceptionName(e)}`,
                                { exception: ApplicationInsights.Util.dump(e) }));
                }
            };
                    ...
                    ApplicationInsights._InternalLogging
                        .throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL,
                            ...
                            ._InternalLogMessage(ApplicationInsights._InternalMessageId.NONUSRACT_FlushFailed,
                                `flush failed, telemetry will not be collected: ${ApplicationInsights.Util
                                .getExceptionName(e)}`,
                                { exception: ApplicationInsights.Util.dump(e) }));
                }
            };
            ...
            AppInsights.prototype.SendCORSException = function(properties) {
                const exceptionData = Microsoft.ApplicationInsights.Telemetry.Exception
            ...
            AppInsights.prototype._onerror = function(message, url, lineNumber, columnNumber, error) {
                try {
                    const properties = { url: url ? url : document.URL };
                    if (ApplicationInsights.Util.isCrossOriginError(message, url, lineNumber, columnNumber, error)) {
                        ...
                        if (!ApplicationInsights.Util.isError(error)) {
                            const stack = `window.onerror@${properties.url}:${lineNumber}:${columnNumber || 0}`;
                    ...
                    const exceptionDump = ApplicationInsights.Util.dump(exception);
                    ApplicationInsights._InternalLogging
                        .throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL,
                            new ApplicationInsights
                            ._InternalLogMessage(ApplicationInsights._InternalMessageId
        ...
        var Timing = (function() {
            ...
            Timing.prototype.stop = function(name, url, properties, measurements) {
                ...
                if (isNaN(start)) {
                    ...
                    const end = +new Date;
                    const duration = ApplicationInsights.Telemetry.PageViewPerformance.getDuration(start, end);
        ...
        const Initialization = (function() {
            ...
            Initialization.prototype.pollInteralLogs = function(appInsightsInstance) {
                return setInterval(function() {
                        const queue = Microsoft.ApplicationInsights._InternalLogging.queue;
            ...
            Initialization.prototype.addHousekeepingBeforeUnload = function(appInsightsInstance) {
                ...
                if (!appInsightsInstance.config.disableFlushOnBeforeUnload && ("onbeforeunload" in window)) {
                    const performHousekeeping = function() {
        ...
        try {
            if (typeof window !== "undefined" && typeof JSON !== "undefined") {
                ...
                if (window[aiName] === undefined) {
                    ...
                    const snippet = window[aiName] || {};
                    const init = new Microsoft.ApplicationInsights.Initialization(snippet);
                    const appInsightsLocal = init.loadAppInsights();
                    for (let field in appInsightsLocal) {
...
(function(AI) {
    "use strict";
    const AjaxCallData = (function(_super) {
...
(function(AI) {
    "use strict";
    const RequestData = (function(_super) {
...
(function(AI) {
    "use strict";
    const SessionStateData = (function(_super) {
...
(function(AI) {
    ...
    const TestResult = AI.TestResult;
})(AI || (AI = {}));